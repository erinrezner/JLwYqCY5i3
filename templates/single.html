...
<!-- wp:column {"width":"100%"} -->
<div class="wp-block-column" style="flex-basis:100%"><!-- wp:group {"tagName":"main","lock":{"move":false,"remove":false},"style":{"spacing":{"blockGap":"var:preset|spacing|70"}}} -->
<div class="featured-bar">
	<div class="featured-bar-inner">
<main class="wp-block-group"><!-- wp:post-featured-image {"align":"full","className":".wp-block-post-featured-image:hover { opacity: 1; }"} /-->
	</div>
	<div class="featured-bar-inner headingtext"><!-- wp:post-title /--></div>
</div>
